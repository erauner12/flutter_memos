...
class TheMemoToUpdateTheNameFieldIsRequired {
  /// Returns a new [TheMemoToUpdateTheNameFieldIsRequired] instance.
  TheMemoToUpdateTheNameFieldIsRequired({
    this.state,
    this.creator,
    this.createTime,
    this.updateTime,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is TheMemoToUpdateTheNameFieldIsRequired &&
    other.state == state &&
  ...
  /// Returns a new [TheMemoToUpdateTheNameFieldIsRequired] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static TheMemoToUpdateTheNameFieldIsRequired? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "TheMemoToUpdateTheNameFieldIsRequired[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "TheMemoToUpdateTheNameFieldIsRequired[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<TheMemoToUpdateTheNameFieldIsRequired> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <TheMemoToUpdateTheNameFieldIsRequired>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = TheMemoToUpdateTheNameFieldIsRequired.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, TheMemoToUpdateTheNameFieldIsRequired> mapFromJson(dynamic json) {
    final map = <String, TheMemoToUpdateTheNameFieldIsRequired>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = TheMemoToUpdateTheNameFieldIsRequired.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of TheMemoToUpdateTheNameFieldIsRequired-objects as value to a dart map
  static Map<String, List<TheMemoToUpdateTheNameFieldIsRequired>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<TheMemoToUpdateTheNameFieldIsRequired>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = TheMemoToUpdateTheNameFieldIsRequired.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
