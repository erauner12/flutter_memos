...
class UserRole {
  ...
  static const ROLE_UNSPECIFIED = UserRole._(r'ROLE_UNSPECIFIED');
  static const HOST = UserRole._(r'HOST');
...
class UserRoleTypeTransformer {
  ...
  UserRole? decode(dynamic data, {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'ROLE_UNSPECIFIED': return UserRole.ROLE_UNSPECIFIED;
        case r'HOST': return UserRole.HOST;
