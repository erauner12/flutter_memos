...
class ResponseArchiveProjectApiV1ProjectsProjectIdArchivePost {
  /// Returns a new [ResponseArchiveProjectApiV1ProjectsProjectIdArchivePost] instance.
  ResponseArchiveProjectApiV1ProjectsProjectIdArchivePost({
    required this.id,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ResponseArchiveProjectApiV1ProjectsProjectIdArchivePost &&
    other.id == id &&
  ...
  @override
  String toString() => 'ResponseArchiveProjectApiV1ProjectsProjectIdArchivePost[id=$id, canAssignTasks=$canAssignTasks, childOrder=$childOrder, color=$color, createdAt=$createdAt, isArchived=$isArchived, isDeleted=$isDeleted, isFavorite=$isFavorite, isFrozen=$isFrozen, name=$name, updatedAt=$updatedAt, viewStyle=$viewStyle, defaultOrder=$defaultOrder, description=$description, parentId=$parentId, inboxProject=$inboxProject, isCollapsed=$isCollapsed, isShared=$isShared, collaboratorRoleDefault=$collaboratorRoleDefault, folderId=$folderId, isInviteOnly=$isInviteOnly, isLinkSharingEnabled=$isLinkSharingEnabled, role=$role, status=$status, workspaceId=$workspaceId]';
  ...
  /// Returns a new [ResponseArchiveProjectApiV1ProjectsProjectIdArchivePost] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ResponseArchiveProjectApiV1ProjectsProjectIdArchivePost? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ResponseArchiveProjectApiV1ProjectsProjectIdArchivePost[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ResponseArchiveProjectApiV1ProjectsProjectIdArchivePost[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<ResponseArchiveProjectApiV1ProjectsProjectIdArchivePost> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ResponseArchiveProjectApiV1ProjectsProjectIdArchivePost>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ResponseArchiveProjectApiV1ProjectsProjectIdArchivePost.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ResponseArchiveProjectApiV1ProjectsProjectIdArchivePost> mapFromJson(dynamic json) {
    final map = <String, ResponseArchiveProjectApiV1ProjectsProjectIdArchivePost>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ResponseArchiveProjectApiV1ProjectsProjectIdArchivePost.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ResponseArchiveProjectApiV1ProjectsProjectIdArchivePost-objects as value to a dart map
  static Map<String, List<ResponseArchiveProjectApiV1ProjectsProjectIdArchivePost>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ResponseArchiveProjectApiV1ProjectsProjectIdArchivePost>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ResponseArchiveProjectApiV1ProjectsProjectIdArchivePost.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
