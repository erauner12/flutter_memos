...
class ResponseGetProjectApiV1ProjectsProjectIdGet {
  /// Returns a new [ResponseGetProjectApiV1ProjectsProjectIdGet] instance.
  ResponseGetProjectApiV1ProjectsProjectIdGet({
    required this.id,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ResponseGetProjectApiV1ProjectsProjectIdGet &&
    other.id == id &&
  ...
  @override
  String toString() => 'ResponseGetProjectApiV1ProjectsProjectIdGet[id=$id, canAssignTasks=$canAssignTasks, childOrder=$childOrder, color=$color, createdAt=$createdAt, isArchived=$isArchived, isDeleted=$isDeleted, isFavorite=$isFavorite, isFrozen=$isFrozen, name=$name, updatedAt=$updatedAt, viewStyle=$viewStyle, defaultOrder=$defaultOrder, description=$description, parentId=$parentId, inboxProject=$inboxProject, isCollapsed=$isCollapsed, isShared=$isShared, collaboratorRoleDefault=$collaboratorRoleDefault, folderId=$folderId, isInviteOnly=$isInviteOnly, isLinkSharingEnabled=$isLinkSharingEnabled, role=$role, status=$status, workspaceId=$workspaceId]';
  ...
  /// Returns a new [ResponseGetProjectApiV1ProjectsProjectIdGet] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ResponseGetProjectApiV1ProjectsProjectIdGet? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ResponseGetProjectApiV1ProjectsProjectIdGet[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ResponseGetProjectApiV1ProjectsProjectIdGet[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<ResponseGetProjectApiV1ProjectsProjectIdGet> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ResponseGetProjectApiV1ProjectsProjectIdGet>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ResponseGetProjectApiV1ProjectsProjectIdGet.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ResponseGetProjectApiV1ProjectsProjectIdGet> mapFromJson(dynamic json) {
    final map = <String, ResponseGetProjectApiV1ProjectsProjectIdGet>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ResponseGetProjectApiV1ProjectsProjectIdGet.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ResponseGetProjectApiV1ProjectsProjectIdGet-objects as value to a dart map
  static Map<String, List<ResponseGetProjectApiV1ProjectsProjectIdGet>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ResponseGetProjectApiV1ProjectsProjectIdGet>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ResponseGetProjectApiV1ProjectsProjectIdGet.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
