...
class ResponseUnarchiveProjectApiV1ProjectsProjectIdUnarchivePost {
  /// Returns a new [ResponseUnarchiveProjectApiV1ProjectsProjectIdUnarchivePost] instance.
  ResponseUnarchiveProjectApiV1ProjectsProjectIdUnarchivePost({
    required this.id,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ResponseUnarchiveProjectApiV1ProjectsProjectIdUnarchivePost &&
    other.id == id &&
  ...
  @override
  String toString() => 'ResponseUnarchiveProjectApiV1ProjectsProjectIdUnarchivePost[id=$id, canAssignTasks=$canAssignTasks, childOrder=$childOrder, color=$color, createdAt=$createdAt, isArchived=$isArchived, isDeleted=$isDeleted, isFavorite=$isFavorite, isFrozen=$isFrozen, name=$name, updatedAt=$updatedAt, viewStyle=$viewStyle, defaultOrder=$defaultOrder, description=$description, parentId=$parentId, inboxProject=$inboxProject, isCollapsed=$isCollapsed, isShared=$isShared, collaboratorRoleDefault=$collaboratorRoleDefault, folderId=$folderId, isInviteOnly=$isInviteOnly, isLinkSharingEnabled=$isLinkSharingEnabled, role=$role, status=$status, workspaceId=$workspaceId]';
  ...
  /// Returns a new [ResponseUnarchiveProjectApiV1ProjectsProjectIdUnarchivePost] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ResponseUnarchiveProjectApiV1ProjectsProjectIdUnarchivePost? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ResponseUnarchiveProjectApiV1ProjectsProjectIdUnarchivePost[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ResponseUnarchiveProjectApiV1ProjectsProjectIdUnarchivePost[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<ResponseUnarchiveProjectApiV1ProjectsProjectIdUnarchivePost> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ResponseUnarchiveProjectApiV1ProjectsProjectIdUnarchivePost>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ResponseUnarchiveProjectApiV1ProjectsProjectIdUnarchivePost.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ResponseUnarchiveProjectApiV1ProjectsProjectIdUnarchivePost> mapFromJson(dynamic json) {
    final map = <String, ResponseUnarchiveProjectApiV1ProjectsProjectIdUnarchivePost>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ResponseUnarchiveProjectApiV1ProjectsProjectIdUnarchivePost.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ResponseUnarchiveProjectApiV1ProjectsProjectIdUnarchivePost-objects as value to a dart map
  static Map<String, List<ResponseUnarchiveProjectApiV1ProjectsProjectIdUnarchivePost>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ResponseUnarchiveProjectApiV1ProjectsProjectIdUnarchivePost>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ResponseUnarchiveProjectApiV1ProjectsProjectIdUnarchivePost.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
