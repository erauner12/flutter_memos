...
class NotesShareNote200Response {
  /// Returns a new [NotesShareNote200Response] instance.
  NotesShareNote200Response({
    required this.id,
    required this.type,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is NotesShareNote200Response &&
    other.id == id &&
    other.type == type &&
  ...
  /// Returns a new [NotesShareNote200Response] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static NotesShareNote200Response? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "NotesShareNote200Response[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "NotesShareNote200Response[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return NotesShareNote200Response(
  ...
  static List<NotesShareNote200Response> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <NotesShareNote200Response>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = NotesShareNote200Response.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, NotesShareNote200Response> mapFromJson(dynamic json) {
    final map = <String, NotesShareNote200Response>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = NotesShareNote200Response.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of NotesShareNote200Response-objects as value to a dart map
  static Map<String, List<NotesShareNote200Response>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<NotesShareNote200Response>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = NotesShareNote200Response.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
