...
class NotesInternalSharedWithMe200ResponseInner {
  /// Returns a new [NotesInternalSharedWithMe200ResponseInner] instance.
  NotesInternalSharedWithMe200ResponseInner({
    required this.id,
    required this.type,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is NotesInternalSharedWithMe200ResponseInner &&
    other.id == id &&
    other.type == type &&
  ...
  /// Returns a new [NotesInternalSharedWithMe200ResponseInner] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static NotesInternalSharedWithMe200ResponseInner? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "NotesInternalSharedWithMe200ResponseInner[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "NotesInternalSharedWithMe200ResponseInner[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return NotesInternalSharedWithMe200ResponseInner(
  ...
  static List<NotesInternalSharedWithMe200ResponseInner> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <NotesInternalSharedWithMe200ResponseInner>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = NotesInternalSharedWithMe200ResponseInner.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, NotesInternalSharedWithMe200ResponseInner> mapFromJson(dynamic json) {
    final map = <String, NotesInternalSharedWithMe200ResponseInner>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = NotesInternalSharedWithMe200ResponseInner.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of NotesInternalSharedWithMe200ResponseInner-objects as value to a dart map
  static Map<String, List<NotesInternalSharedWithMe200ResponseInner>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<NotesInternalSharedWithMe200ResponseInner>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = NotesInternalSharedWithMe200ResponseInner.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
