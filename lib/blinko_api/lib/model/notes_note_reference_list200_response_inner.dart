...
class NotesNoteReferenceList200ResponseInner {
  /// Returns a new [NotesNoteReferenceList200ResponseInner] instance.
  NotesNoteReferenceList200ResponseInner({
    required this.id,
    required this.type,
    ...
    required this.referenceCreatedAt,
  });
  ...
  String referenceCreatedAt;

  @override
  bool operator ==(Object other) => identical(this, other) || other is NotesNoteReferenceList200ResponseInner &&
    other.id == id &&
    other.type == type &&
    ...
    other.referenceCreatedAt == referenceCreatedAt;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.accountId != null) {
      ...
      json[r'referenceCreatedAt'] = this.referenceCreatedAt;
    return json;
  }

  /// Returns a new [NotesNoteReferenceList200ResponseInner] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static NotesNoteReferenceList200ResponseInner? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "NotesNoteReferenceList200ResponseInner[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "NotesNoteReferenceList200ResponseInner[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return NotesNoteReferenceList200ResponseInner(
        ...
        referenceCreatedAt: mapValueOfType<String>(json, r'referenceCreatedAt')!,
      );
    }
    return null;
  }

  static List<NotesNoteReferenceList200ResponseInner> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <NotesNoteReferenceList200ResponseInner>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = NotesNoteReferenceList200ResponseInner.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, NotesNoteReferenceList200ResponseInner> mapFromJson(dynamic json) {
    final map = <String, NotesNoteReferenceList200ResponseInner>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = NotesNoteReferenceList200ResponseInner.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of NotesNoteReferenceList200ResponseInner-objects as value to a dart map
  static Map<String, List<NotesNoteReferenceList200ResponseInner>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<NotesNoteReferenceList200ResponseInner>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = NotesNoteReferenceList200ResponseInner.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
