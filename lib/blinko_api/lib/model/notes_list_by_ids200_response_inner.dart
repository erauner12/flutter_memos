...
class NotesListByIds200ResponseInner {
  /// Returns a new [NotesListByIds200ResponseInner] instance.
  NotesListByIds200ResponseInner({
    required this.id,
    required this.type,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is NotesListByIds200ResponseInner &&
    other.id == id &&
    other.type == type &&
  ...
  /// Returns a new [NotesListByIds200ResponseInner] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static NotesListByIds200ResponseInner? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "NotesListByIds200ResponseInner[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "NotesListByIds200ResponseInner[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return NotesListByIds200ResponseInner(
  ...
  static List<NotesListByIds200ResponseInner> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <NotesListByIds200ResponseInner>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = NotesListByIds200ResponseInner.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, NotesListByIds200ResponseInner> mapFromJson(dynamic json) {
    final map = <String, NotesListByIds200ResponseInner>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = NotesListByIds200ResponseInner.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of NotesListByIds200ResponseInner-objects as value to a dart map
  static Map<String, List<NotesListByIds200ResponseInner>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<NotesListByIds200ResponseInner>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = NotesListByIds200ResponseInner.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
