...
class MigrationUtils {
  ...
  static Comment adaptCommentForTarget(
    ...
    return Comment(
      id: '', // ID generated by target
      content: sourceComment.content,
      // Keep original create time? Target might override.
      createTime: sourceComment.createTime,
      // Update time set by target
      updateTime: DateTime.now().millisecondsSinceEpoch,
      // Creator ID might not be mappable
      creatorId: null, // Or map if possible
      pinned: sourceComment.pinned, // Assuming pinned is compatible
      state: targetState,
      // Assuming resources are handled at the note level or not supported for comments here
      resources: const [],
    );
  }
}
